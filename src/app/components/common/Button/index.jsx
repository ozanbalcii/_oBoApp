...
const Button = forwardRef(function ButtonComponent(
  ...
  const activeButtonClass = isActive
    ...
    : "";
  const classNames = `font-bold relative flex cursor-pointer items-center justify-center transition-all pl-[9.5px] pr-[9.5px] hover:bg-[#F8FAFC] hover:bg-opacity-20 rounded-[0.2rem] ${style} ${activeButtonClass}`;
  return (
    <>
      {type === "button" ? (
        <button
