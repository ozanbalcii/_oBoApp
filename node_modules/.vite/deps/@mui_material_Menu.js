...
import {
  ...
  init_ownerWindow,
  ownerWindow_default
} from "./chunk-JZIJELLE.js";
import {
  Transition_default
} from "./chunk-TS3L3UXG.js";
import {
  MenuList_default,
  require_react_is
} from "./chunk-4TF7ZILP.js";
import {
  init_ownerDocument,
  ownerDocument_default
} from "./chunk-ZVW6FB2L.js";
import "./chunk-XTV5GFIB.js";
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-WLJPR7HI.js";
import {
  Paper_default,
  useTheme
} from "./chunk-UEG3LL7P.js";
import "./chunk-PVZNQFT3.js";
import {
  Popper,
  Portal
} from "./chunk-OVO7Q6XV.js";
import {
  require_react_dom
} from "./chunk-YAPSZIQJ.js";
import "./chunk-LTTSDBIU.js";
import "./chunk-ASH5ZFT5.js";
import "./chunk-ZWLKKE3W.js";
import {
  ...
  useList,
  useListItem
} from "./chunk-U7U26A3H.js";
import "./chunk-IMDLBN4X.js";
import {
  useButton
} from "./chunk-7IQVKUNQ.js";
import {
  areArraysEqual,
  ...
  useSlotProps
} from "./chunk-WYCTLSXO.js";
import "./chunk-5XQW2G5R.js";
...
import {
  ...
  styled_default,
  useThemeProps
} from "./chunk-E2VEQDNR.js";
import {
  init_composeClasses
} from "./chunk-ZWDC4NFC.js";
import "./chunk-VHP3VQQB.js";
import {
  _objectWithoutPropertiesLoose,
  clsx_default,
  init_clsx,
  init_objectWithoutPropertiesLoose
} from "./chunk-TO6UZGNF.js";
import {
  HTMLElementType,
  _extends,
  chainPropTypes,
...
var FormControl = React6.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children,
  ...
  React6.useEffect(() => setFocused((isFocused) => disabled ? false : isFocused), [disabled]);
  const ownerState = _extends({}, props, {
    disabled,
    error,
    filled,
...
function useFormControlContext() {
  return React7.useContext(FormControlContext);
}
...
var _excluded5 = ["children", "closeAfterTransition", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onKeyDown", "open", "onTransitionEnter", "onTransitionExited", "slotProps", "slots"];
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React13.useState(value ? String(value) : void 0);
  React13.useEffect(() => {
...
var _excluded6 = ["className", "defaultValue", "disabled", "endAdornment", "error", "id", "max", "min", "onBlur", "onInputChange", "onFocus", "onChange", "placeholder", "required", "readOnly", "shiftMultiplier", "startAdornment", "step", "value", "slotProps", "slots"];
...
var NumberInput = React14.forwardRef(function NumberInput2(props, forwardedRef) {
...
true ? NumberInput.propTypes = {
   ...
   */
  shiftMultiplier: import_prop_types9.default.number,
  /**
   * The props used for each slot inside the NumberInput.
   * @default {}
   */
  slotProps: import_prop_types9.default.shape({
    decrementButton: import_prop_types9.default.oneOfType([import_prop_types9.default.func, import_prop_types9.default.object]),
    incrementButton: import_prop_types9.default.oneOfType([import_prop_types9.default.func, import_prop_types9.default.object]),
  ...
  slots: import_prop_types9.default.shape({
    decrementButton: import_prop_types9.default.elementType,
    incrementButton: import_prop_types9.default.elementType,
...
var _excluded7 = ["disabled", "slotProps", "slots"];
...
var OptionGroup = React15.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
function useOptionContextStabilizer(value) {
  ...
  const localGetItemState = React17.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React17.useMemo(() => ({
    dispatch,
...
var _excluded8 = ["children", "disabled", "label", "slotProps", "slots", "value"];
...
var InnerOption = React18.memo(React18.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React18.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
  ...
  return (0, import_jsx_runtime17.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime17.jsx)(InnerOption, _extends({}, props, {
      ref
    }))
  });
});
...
var _excluded9 = ["anchor", "children", "container", "disablePortal", "keepMounted", "middleware", "offset", "open", "placement", "slotProps", "slots", "strategy", "withTransition"];
...
true ? Popup.propTypes = {
   ...
   * @default false
   */
  withTransition: import_prop_types12.default.bool
} : void 0;
...
function useSelect(props) {
  ...
  const optionValues = React21.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React21.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React21.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React21.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React21.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React21.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React21.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React21.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React21.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const getOptionMetadata = React21.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React21.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
var _span;
var _excluded10 = ["areOptionsEqual", "autoComplete", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "placeholder", "slotProps", "slots", "value"];
...
var Select = React23.forwardRef(function Select2(props, forwardedRef) {
  ...
  const [buttonDefined, setButtonDefined] = React23.useState(false);
  ...
  const handleButtonRefChange = React23.useCallback((element) => {
  ...
  return (0, import_jsx_runtime21.jsxs)(React23.Fragment, {
    ...
    })), (0, import_jsx_runtime20.jsx)("input", _extends({}, getHiddenInputProps(), {
      autoComplete
    }))]
  });
});
true ? Select.propTypes = {
   ...
   */
  placeholder: import_prop_types13.default.node,
  /**
...
var _excluded11 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var Slider = React25.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime23.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime22.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime22.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
...
function useSnackbar(parameters = {}) {
  ...
  const timerAutoHide = React26.useRef();
  React26.useEffect(() => {
    if (!open) {
      return void 0;
    }
  ...
  const handleResume = React26.useCallback(() => {
...
var _excluded12 = ["autoHideDuration", "children", "disableWindowBlurListener", "exited", "onBlur", "onClose", "onFocus", "onMouseEnter", "onMouseLeave", "open", "resumeHideDuration", "slotProps", "slots"];
...
var Snackbar = React27.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var _excluded13 = ["checked", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "slotProps", "slots"];
...
var Switch = React29.forwardRef(function Switch2(props, forwardedRef) {
...
var _excluded14 = ["count", "getItemAriaLabel", "onPageChange", "page", "rowsPerPage", "showFirstButton", "showLastButton", "direction", "ownerState", "slotProps", "slots"];
var _span2;
var _span22;
var _span3;
var _span4;
...
var TablePaginationActions = React30.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var _excluded15 = ["colSpan", "count", "getItemAriaLabel", "labelDisplayedRows", "labelId", "labelRowsPerPage", "onPageChange", "onRowsPerPageChange", "page", "rowsPerPage", "rowsPerPageOptions", "selectId", "slotProps", "slots"];
...
var TablePagination = React31.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime30.jsxs)(Toolbar, _extends({}, toolbarProps, {
      children: [(0, import_jsx_runtime29.jsx)(Spacer, _extends({}, spacerProps)), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime29.jsx)(SelectLabel, _extends({}, selectLabelProps, {
        ...
        children: rowsPerPageOptions.map((rowsPerPageOption) => (0, import_react2.createElement)(MenuItem, _extends({}, menuItemProps, {
...
function useTabs(parameters) {
  ...
  const onSelected = React32.useCallback((event, newValue) => {
    setValue(newValue);
    onChange == null || onChange(event, newValue);
  }, [onChange, setValue]);
  const {
  ...
  const tabIdLookup = React32.useRef(() => void 0);
  const getTabPanelId = React32.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React32.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React32.useCallback((lookupFunction) => {
...
function useTabsContext() {
  const context = React33.useContext(TabsContext);
  if (context == null) {
...
var _excluded16 = ["children", "value", "defaultValue", "orientation", "direction", "onChange", "selectionFollowsFocus", "slotProps", "slots"];
...
var Tabs = React35.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React36.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var _excluded17 = ["children", "value", "slotProps", "slots"];
...
var TabPanel = React37.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React38.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React38.useCallback((tabValue) => {
  ...
  const handleChange = React38.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React38.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React38.useCallback((item) => {
  ...
  const contextValue = React38.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var _excluded18 = ["children", "slotProps", "slots"];
...
var TabsList = React40.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var _excluded19 = ["action", "children", "disabled", "onChange", "onClick", "onFocus", "slotProps", "slots", "value"];
...
var Tab = React42.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
var Modal3 = React48.forwardRef(function Modal4(inProps, ref) {
  ...
  return (0, import_jsx_runtime42.jsx)(Portal, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime43.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime42.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime42.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
...
var Popover = React49.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime44.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
...
var Menu = React50.forwardRef(function Menu2(inProps, ref) {
  ...
  React50.Children.map(children, (child, index2) => {
