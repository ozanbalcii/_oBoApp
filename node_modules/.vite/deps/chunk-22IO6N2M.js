import {
  Popper,
  Portal
} from "./chunk-PYBAFLN2.js";
import {
  autoUpdate,
  computePosition,
  flip,
  offset
} from "./chunk-5F7ZPEFH.js";
import {
  require_react_dom
...
import {
  ...
  useList,
  useListItem
} from "./chunk-HJX6VCJB.js";
import {
  useButton
} from "./chunk-I5PDVJED.js";
import {
  combineHooksSlotProps
} from "./chunk-GPUXLQD7.js";
import {
  areArraysEqual,
  ...
  useSlotProps
} from "./chunk-RAR7TSYF.js";
import {
  init_composeClasses
} from "./chunk-AJKPWHLU.js";
import {
  clsx_default,
  init_clsx
...
var FormControl = React7.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children,
...
function useFormControlContext() {
  return React8.useContext(FormControlContext);
}
...
var _excluded6 = ["children", "closeAfterTransition", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onKeyDown", "open", "onTransitionEnter", "onTransitionExited", "slotProps", "slots"];
...
var Modal = React12.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
  ...
  return (0, import_jsx_runtime12.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime13.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime12.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime12.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime14.jsx)(React13.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React14.useState(value ? String(value) : void 0);
  React14.useEffect(() => {
...
var _excluded7 = ["className", "defaultValue", "disabled", "endAdornment", "error", "id", "max", "min", "onBlur", "onInputChange", "onFocus", "onChange", "placeholder", "required", "readOnly", "shiftMultiplier", "startAdornment", "step", "value", "slotProps", "slots"];
...
var NumberInput = React15.forwardRef(function NumberInput2(props, forwardedRef) {
...
true ? NumberInput.propTypes = {
   ...
   */
  shiftMultiplier: import_prop_types10.default.number,
  /**
   * The props used for each slot inside the NumberInput.
   * @default {}
   */
  slotProps: import_prop_types10.default.shape({
    decrementButton: import_prop_types10.default.oneOfType([import_prop_types10.default.func, import_prop_types10.default.object]),
    incrementButton: import_prop_types10.default.oneOfType([import_prop_types10.default.func, import_prop_types10.default.object]),
  ...
  slots: import_prop_types10.default.shape({
    decrementButton: import_prop_types10.default.elementType,
    incrementButton: import_prop_types10.default.elementType,
...
var _excluded8 = ["disabled", "slotProps", "slots"];
...
var OptionGroup = React16.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
function useOption(params) {
  ...
  const optionRef = React17.useRef(null);
  const selectOption = React17.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
var _excluded9 = ["children", "disabled", "label", "slotProps", "slots", "value"];
...
var InnerOption = React19.memo(React19.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React19.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var _excluded10 = ["anchor", "children", "container", "disablePortal", "keepMounted", "middleware", "offset", "open", "placement", "slotProps", "slots", "strategy", "withTransition"];
...
var Popup = React21.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
...
true ? Popup.propTypes = {
   ...
   * @default false
   */
  withTransition: import_prop_types13.default.bool
} : void 0;
...
var _span;
var _excluded11 = ["areOptionsEqual", "autoComplete", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "placeholder", "slotProps", "slots", "value"];
...
var Select = React24.forwardRef(function Select2(props, forwardedRef) {
  ...
  const [buttonDefined, setButtonDefined] = React24.useState(false);
  ...
  const handleButtonRefChange = React24.useCallback((element) => {
...
true ? Select.propTypes = {
   ...
   */
  placeholder: import_prop_types14.default.node,
  /**
...
var Slider = React26.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime25.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime24.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime24.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index2) => {
...
var Snackbar = React28.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React30.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React31.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React32.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React33.useCallback((event, newValue) => {
    setValue(newValue);
    onChange == null || onChange(event, newValue);
  }, [onChange, setValue]);
  const {
  ...
  const tabIdLookup = React33.useRef(() => void 0);
  const getTabPanelId = React33.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React33.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React33.useCallback((lookupFunction) => {
...
function useTabsContext() {
  const context = React34.useContext(TabsContext);
  if (context == null) {
...
var Tabs = React36.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React37.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React38.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var TabsList = React41.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTab(parameters) {
  ...
  const tabRef = React42.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React42.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var _excluded20 = ["action", "children", "disabled", "onChange", "onClick", "onFocus", "slotProps", "slots", "value"];
...
var Tab = React43.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-22IO6N2M.js.map
